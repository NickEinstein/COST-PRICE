  ...
  return (
    <div className="relative w-full my-8">
      <div className="mb-8 flex justify-between">
        ...
        <Button className="text-white bg-red-500"> Report Orders</Button>
      </div>
      ...
      <Paper elevation={3} className="p-5">
                ...
                <div className="bg-[#F8F8F8] w-3/4 rounded-2xl  px-4 ">
                  <div className="w-full">
                    <div className="flex mt-2 gap-3 items-center">
                      <Typography className="font-bold ml-2 w-full">
                        Fulfilment status:
                      </Typography>
                      <Typography className="border-[#C4C4C4] w-full rounded-3xl bg-white px-3 py-2">
                        Delivered
                      </Typography>
                    </div>
        ...
        <div>
          <Typography
            fullWidth
            className="mt-6 rounded-3xl p-3 text-lg font-bold border border-[#C4C4C4]"
          >
            Shipping Details
          </Typography>
          ...
          <div class="mb-8">
            <div className="flex gap-4 w-full mt-3">
              <div className="w-1/3">
                <div className="flex mt-4 gap-1">
                  <Typography className="font-bold ml-2">Address:</Typography>
                  <Typography className="">
                    993 E. Brewer St. Holtsville
                  </Typography>
                </div>
              </div>
              <div class="w-1/3">
                <div className="flex mt-4 gap-1">
                  <Typography className="font-bold ml-2">Phone:</Typography>
